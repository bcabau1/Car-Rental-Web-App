...
<section class="cid-rSGemtvQVk" id="content7-f">
    ...
    <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Manage Customer </h3>
<?php
// Storing Session
...
<div style="overflow-x:auto;">
  ...
  <tbody>
    <tr>
      ...
      <td><a style ="display:block;width:100%;height:100%;margin:0;" href="cus_reservation.php?id=<?php echo($cus_ID) ?>"><?php echo($cus_ID)?></a></td>
      
      <td><?php echo $row["cus_FName"]; ?></td>
      <td><?php echo $row["cus_username"]; ?></td>
      <td><?php echo $row["cus_phone_no"]; ?></td>
