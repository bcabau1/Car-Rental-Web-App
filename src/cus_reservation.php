   ...
   <div style="margin-top: 65px;" >
    <div style="float: none; margin: 0 auto; width: 90%">
          ...
          <br style="clear: both">
              ...
              $mysql0 = "SELECT * FROM customer WHERE cus_ID = '$customer_id'";
...
<div class="container">
      <div class="jumbotron" style ="text-align: center">
        <h2 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> <?php echo($customer_name) ?>'s Reservation </h2><br>
