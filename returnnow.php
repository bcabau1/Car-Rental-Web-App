...
<?php
  ...
  <section class="features19 cid-qIjES4e5vV" id="features19-5">
   <div style="margin-top: 65px;" >
    ...
    WHERE r.res_cus_ID='$customer_id' AND c.car_ID=r.res_car_ID AND r.res_status = 'NR'";
...
<?php if ($today > $rent_start_date){?>
<td><a href="returncar.php?id=<?php echo $row["res_ID"];?>"> Return </a></td>
<?php } else { ?>
<td><a href="returncar.php?id=<?php echo $row["res_ID"];?>"> Cancel </a></td>
<?php }?>
</tr>
<?php } ?>
  </table>
