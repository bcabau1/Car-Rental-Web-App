...
if(isset($_SESSION['login_customer'])){
  $_SESSION['start'] = time(); // Taking now logged in time.
            // Ending a session in 1/2 minutes from the starting time for testing
            // in real life, change 1/2 by any numbner in minute, don't change 60 

  $_SESSION['expire'] = $_SESSION['start'] + (1/2 * 60);
